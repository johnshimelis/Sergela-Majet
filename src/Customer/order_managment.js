...
import OrderManagmentPending from './order_managment_pending';
...
function OrderManagment() {
  ...
  function NavigateToPending(){
    navigate('/order_managment_pending');
  }
const menu = (
  <Menu
    items={[
      ...
      },
      {
        key: '2',
        label: (
          <a target="_blank" onClick={NavigateToPending}>
            Pending
          </a>
        ),
      },
  ...
  return (
    <div className='order_managment'>
        <div className='container-fluid'>
           ...
           >
            <div className='items'>
              <h6 style={{marginLeft:-30}}>#2340 </h6>
              <h6>ቲማቲም</h6>
              <h6 style={{marginLeft:50}}>82 ብር</h6>
              <Tag style={{height:25, marginLeft:30, background:'#88D4BD', marginTop:-10}}>Successful</Tag>
              <h6 style={{paddingLeft:100}}>05-04-2022</h6>
           ...
           >
            <div className='items'>
              <h6 style={{marginLeft:-30}}>#2342 </h6>
              <h6>ኦማር ዘይት</h6>
              <h6 style={{marginLeft:50}}>948 ብር</h6>
              <Tag style={{height:25, marginLeft:30, background:'#88D4BD', marginTop:-10}}>Successful</Tag>
              <h6 style={{paddingLeft:100}}>19-03-2022</h6>
              <h6 style={{marginLeft:100}}><EyeOutlined /></h6>
              </div>
           ...
           >
            <div className='items'>
              <h6 style={{marginLeft:-30}}>#2343 </h6>
              <h6>ሳሙና</h6>
              <h6 style={{marginLeft:50}}>56 ብር</h6>
              <Tag style={{height:25, marginLeft:30, background:'#88D4BD', marginTop:-10}}>Successful</Tag>
              <h6 style={{paddingLeft:100}}>19-03-2022</h6>
              <h6 style={{marginLeft:100}}><EyeOutlined /></h6>
              </div>
           ...
           >
            <div className='items'>
              <h6 style={{marginLeft:-30}}>#2344 </h6>
              <h6>እንቁላል</h6>
              <h6 style={{marginLeft:50}}>120 ብር</h6>
              <Tag style={{height:25, marginLeft:30, background:'#88D4BD', marginTop:-10}}>Successful</Tag>
              <h6 style={{paddingLeft:100}}>02-03-2022</h6>
              <h6 style={{marginLeft:100}}><EyeOutlined /></h6>
              </div>
           ...
           >
            <div className='items'>
              <h6 style={{marginLeft:-30}}>#2345</h6>
              <h6>ሽንኩርት</h6>
              <h6 style={{marginLeft:50}}>253 ብር</h6>
              <Tag style={{height:25, marginLeft:30, background:'#E56154', marginTop:-10}}>Overdue</Tag>
              <h6 style={{paddingLeft:100}}>02-11-2021</h6>
              <h6 style={{marginLeft:100}}><EyeOutlined /></h6>
              </div>
           ...
           >
            <div className='items'>
              <h6 style={{marginLeft:-30}}>#2346</h6>
              <h6>ጥቅል ጎመን</h6>
              <h6 style={{marginLeft:50}}>82 ብር</h6>
              <Tag style={{height:25, marginLeft:30, background:'#88D4BD', marginTop:-10}}>Successful</Tag>
              <h6 style={{paddingLeft:100}}>12-03-2022</h6>
              <h6 style={{marginLeft:100}}><EyeOutlined /></h6>
              </div>
           ...
           >
            <div className='items'>
              <h6 style={{marginLeft:-30}}>#2348</h6>
              <h6>ስንዴ</h6>
              <h6 style={{marginLeft:50}}>800 ብር</h6>
              <Tag style={{height:25, marginLeft:30, background:'#88D4BD', marginTop:-10}}>Overdue</Tag>
              <h6 style={{paddingLeft:100}}>12-05-2022</h6>
              <h6 style={{marginLeft:100}}><EyeOutlined /></h6>
              </div>
