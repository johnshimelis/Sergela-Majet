    ...
    <div className='cart_page'>
        <div className='container-fluid'>
           ...
           <div className='content'>
             ...
             <h5>2 እቃዎች <a href='#'>መገብየትዎን ይቀጥሉ!</a></h5> 
           ...
           style={{ width: 180, height: 180, marginTop:50, background:'#FAFAFA'}}
            cover={<img alt="አስቤዛ መካከለኛ ቤተሰብ" src={image} />}
           >
           </Card>
           <div className='description'>
             <h5>ቲማቲም</h5>
             <p>ትኩስ እና ጣፍጭ ቲማቲሞች በበጋ ወቅት ተወዳጅ ናቸው .  ቲማቲሞች ለስልስ እና ለሳልሳዎች 
               ተስማሚ ናቸዉ ። ወይም በቀላሉ ለመመገብ በእጽዋት እና በወይራ ዘይት ውስጥ ለማርባት ይሞክሩ።</p>
               <h6>መጠን ፡ 1 ኪ.ግ</h6>
               <h6 style={{marginTop:10}}>የአንዱ ዋጋ : 40 ብር</h6>
           </div>
