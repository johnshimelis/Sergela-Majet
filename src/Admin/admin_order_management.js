...
function AdminOrderManagement(){
    ...
    function navigateSuccessful(){
        navigate('/successfully_ordered');
    }
    const menu = (
        <Menu
          items={[
            ...
            },
            {
              key: '4',
              label: (
                <a target="_blank" rel="noopener noreferrer" onClick={navigateSuccessful}>
                  Successful
                </a>
              ),
            },
          ...
          <h6 style={{fontSize:16,fontWeight:'bold',color:'#252733',marginTop:30, marginLeft:150}}>አሁን ላይ  እየተካሄዱ ያሉ ትእዛዞች</h6>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>82 ብር</h6>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:12,marginTop:-10}}>#2341 </h6>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-40,marginLeft:440}}>ድንች</h6>
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>63 ብር</h6>
                  <div className='tag' style={{marginTop:-27}}>
                    <Tag style={{fontSize:13,color:'#252733',height:25, marginLeft:790,background:'#FBDA85'}}>Pending</Tag>
                  </div>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:950,marginTop:-25}}>25-03-2022</h6>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>948 ብር</h6>
                  <div className='tag' style={{marginTop:-27}}>
                    <Tag style={{fontSize:13,color:'#252733',height:25, marginLeft:790,background:'#88D4BD'}}>Successful</Tag>
                  </div>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>56 ብር</h6>
                  <div className='tag' style={{marginTop:-27}}>
                    <Tag style={{fontSize:13,color:'#252733',height:25, marginLeft:790,background:'#88D4BD'}}>Successful</Tag>
                  </div>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:950,marginTop:-25}}>19-03-2022</h6>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>120 ብር</h6>
                  <div className='tag' style={{marginTop:-27}}>
                    <Tag style={{fontSize:13,color:'#252733',height:25, marginLeft:790,background:'#88D4BD'}}>Successful</Tag>
                  </div>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:12,marginTop:-10}}>#2345 </h6>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-40,marginLeft:440}}>ሽንኩርት</h6>
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>253 ብር</h6>
                  <div className='tag' style={{marginTop:-27}}>
                    <Tag style={{fontSize:13,color:'#252733',height:25, marginLeft:790,background:'#E56154'}}>Overdue</Tag>
                  </div>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:950,marginTop:-25}}>02-11-2021</h6>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:12,marginTop:-10}}>#2347 </h6>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-40,marginLeft:440}}>ዝኩኒ</h6>
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>204 ብር</h6>
                  <div className='tag' style={{marginTop:-27}}>
                    <Tag style={{fontSize:13,color:'#252733',height:25, marginLeft:790,background:'#FBDA85'}}>Pending</Tag>
                  </div>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:950,marginTop:-25}}>18-01-2022</h6>
           ...
           <Card className='second_card' hoverable style={{ width: 1120, height: 50, marginTop:20, background:'#FFF'}}>
            <div className='items'>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:12,marginTop:-10}}>#2348</h6>
              ...
              <h6 style={{fontSize:13,color:'#252733',marginTop:-40,marginLeft:440}}>ስንዴ</h6>
              <h6 style={{fontSize:13,color:'#252733',marginTop:-21,paddingLeft:620}}>800 ብር</h6>
                  <div className='tag' style={{marginTop:-27}}>
                    <Tag style={{fontSize:13,color:'#252733',height:25, marginLeft:790,background:'#88D4BD'}}>Overdue</Tag>
                  </div>
              <h6 style={{fontSize:13,color:'#252733',marginLeft:950,marginTop:-25}}>12-05-2022</h6>
